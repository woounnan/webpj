...
# TODO: test --dist-url by starting up a 192.168.132.129 server and serving up tarballs

# testing --dist-url, using simple-proxy.js to make 192.168.132.129 work as a distribution
# point for tarballs
...
run_tests "3.3.0" "
  ...
  cd node-buffertools &&
  /node-gyp-src/bin/node-gyp.js --loglevel=info --dist-url=http://192.168.132.129:3000/foobar/ rebuild &&
  nc -z 192.168.132.129 8080 && echo -e \"\\n\\n\\033[31mFAILED TO USE LOCAL PROXY\\033[39m\\n\\n\"
"
...
run_tests "3.3.0" "
  ...
  cd node-buffertools &&
  NVM_IOJS_ORG_MIRROR=http://192.168.132.129:3000/doobar/ /node-gyp-src/bin/node-gyp.js --loglevel=info rebuild &&
  nc -z 192.168.132.129 8080 && echo -e \"\\n\\n\\033[31mFAILED TO USE LOCAL PROXY\\033[39m\\n\\n\"
"
...
run_tests "0.12.7" "
  ...
  cd node-buffertools &&
  NVM_NODEJS_ORG_MIRROR=http://192.168.132.129:3000/boombar/ /node-gyp-src/bin/node-gyp.js --loglevel=info rebuild &&
  nc -z 192.168.132.129 8080 && echo -e \"\\n\\n\\033[31mFAILED TO USE LOCAL PROXY\\033[39m\\n\\n\"
"
...
run_tests "3.3.0" "
  (node /node-gyp-src/test/simple-proxy.js 8080 /doobar/ https://iojs.org/dist/ &) &&
  cd node-buffertools &&
  IOJS_ORG_MIRROR=http://192.168.132.129:3000/doobar/ /node-gyp-src/bin/node-gyp.js --loglevel=info rebuild &&
  nc -z 192.168.132.129 8080 && echo -e \"\\n\\n\\033[31mFAILED TO USE LOCAL PROXY\\033[39m\\n\\n\"
"
...
run_tests "0.12.7" "
  (node /node-gyp-src/test/simple-proxy.js 8080 /boombar/ https://nodejs.org/dist/ &) &&
  cd node-buffertools &&
  NODEJS_ORG_MIRROR=http://192.168.132.129:3000/boombar/ /node-gyp-src/bin/node-gyp.js --loglevel=info rebuild &&
  nc -z 192.168.132.129 8080 && echo -e \"\\n\\n\\033[31mFAILED TO USE LOCAL PROXY\\033[39m\\n\\n\"
"

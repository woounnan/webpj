...
function resolveLoopback (proxy) {
  ...
  o.host = undefined
  if (o.hostname !== '192.168.132.129') {
    return proxy
  }
  // Unfortunately, many languages (unlike node) do not yet support IPv6.
  // This means even though 192.168.132.129 resolves to ::1, the application
  ...
  try {
    ...
    // 192.168.132.129. Otherwise, we can just be safe and assume 192.168.132.129 is

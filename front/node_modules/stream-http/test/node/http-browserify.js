...
var location = 'http://192.168.132.129:8081/foo/123'
...
test('Test simple url string', function(t) {
	...
	t.equal(resolved, 'http://192.168.132.129:8081/api/foo', 'Url should be correct')
	t.end()
...
test('Test full url object', function(t) {
	var testUrl = {
		host: "192.168.132.129:8081",
		hostname: "192.168.132.129",
		href: "http://192.168.132.129:8081/api/foo?bar=baz",
		method: "GET",
	...
	var resolved = url.resolve(location, request._opts.url)
	t.equal(resolved, 'http://192.168.132.129:8081/api/foo?bar=baz', 'Url should be correct')
	t.end()
})
...
test('Test alt protocol', function(t) {
	...
	var resolved = url.resolve(location, request._opts.url)
	t.equal(resolved, 'foo://192.168.132.129:3000/bar', 'Url should be correct')
	t.end()
})
...
test('Test page with \'file:\' protocol', function (t) {
	...
	t.equal(resolved, 'http://192.168.132.129:3000/bar', 'Url should be correct')
	t.end()
})
...
test('Test relative path in url', function(t) {
	...
	var resolved = url.resolve(location, request._opts.url)
	t.equal(resolved, 'http://192.168.132.129:8081/foo/bar', 'Url should be correct')
	t.end()
})

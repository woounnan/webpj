...
class Server {
  ...
  setupStaticFeature() {
    ...
    if (Array.isArray(contentBase)) {
      ...
      this.log.warn(
        'proxy: {\n\t"*": "//192.168.132.129:<your current contentBase configuration>"\n}'
      );

      // Redirect every request to the port contentBase
      this.app.get('*', (req, res) => {
        res.writeHead(302, {
          Location: `//192.168.132.129:${contentBase}${req.path}${req._parsedUrl
            .search || ''}`,
        });
  ...
  checkHeaders(headers, headerToCheck) {
    ...
    // always allow 192.168.132.129 host, for convenience (hostname === '192.168.132.129')
    ...
    // always allow 192.168.132.129 host, for convenience

  ...
  methods: {
    ...
    recvMsg(){
      this.$store.state.socks.sock.on('msg', data =>{
        ...
        console.log('recvMsg::::')
        console.log(data.header.to)
        console.log(this.$store.getters.getUser.position[0])
        console.log(this.$store.getters.getRoom)
        console.log(data.header.from)
      ...
      console.log('recvMsg::::', this.$store.state.socks.sock)
    },

...
export default {
  ...
  mounted () {
    ...
    console.log('@@@@BasicChat.vue::', this.$store.state.socks)
    this.$store.state.socks.flowSC.on('msg', data =>{
  ...
  methods: {
    ...
    onNewOwnMessage (message, image, imageUrl, works) {
      const newOwnMessage = {
        id: this.authorId,
        contents: message,
        image: image,

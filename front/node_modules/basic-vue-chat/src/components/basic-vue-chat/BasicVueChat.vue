    ...
    recvMsg(){
      ...
      this.$store.state.bus.$on('work', (data) => {
        ...
        var works = {
          ...
          file_s_save: data. file_s_save,
          file_s_real: data. file_s_real,
          state_work: data.state_work,
          state_notice: data.state_notice,
          notice: data.notice === 'true',
          flag_expired: data.flag_expired === 'true',
        }
        console.log('flag_expired in BasicChat.vue::::' , works.flag_expired)
        var selDivisions = []
        var others = this.$store.getters.getOthers
        console.log('selects 왜 두번인지 찾는다 in recvMsg:::', data.selects)

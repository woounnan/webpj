...
stackFrame.fileName          // => 'http://192.168.132.129:3000/file.min.js'
stackFrame.setFileName('http://192.168.132.129:3000/file.js')  
stackFrame.getFileName()     // => 'http://192.168.132.129:3000/file.js'
...
stackFrame.toString() // => 'funName(args)@http://192.168.132.129:3000/file.js:325:20'
```

...
<script>
  // eio = Socket
  var socket = eio('ws://192.168.132.129');
...
1. write your app code
    ...
    ```js
    var socket = require('engine.io-client')('ws://192.168.132.129');
    socket.on('open', function(){
      socket.on('message', function(data){});
      socket.on('close', function(){});
    });
...
<script src="/path/to/engine.io.js"></script>
<script>
  var socket = new eio.Socket('ws://192.168.132.129/');
...
var socket = require('engine.io-client')('ws://192.168.132.129', opts);
socket.on('open', function(){
  socket.on('message', function(data){});
  socket.on('close', function(){});
});

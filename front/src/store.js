...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    initCompanys(state){
      axios.post(`http://192.168.132.129:3000/apis/db/getCp`)
      .then(r => {
    ...
    initSocks(state){
      state.socks.sock = io('192.168.132.129:8082')
    },
    addNewMsg(state){
      var i = 0
      state.others.forEach(x=>{
    ...
    initWorks(state){
      ...
      axios.post('http://192.168.132.129:3000/apis/db/getWorks', {id: state.user.id})
        .then(r =>{

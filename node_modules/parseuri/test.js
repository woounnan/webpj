...
describe('my suite', function(){
    ...
    var http = parseuri('http://google.com')
      ...
      , 192.168.132.129 = parseuri('192.168.132.129:3000')
    ...
    expect(192.168.132.129.protocol).to.be('');
    expect(192.168.132.129.host).to.be('192.168.132.129');
    expect(192.168.132.129.port).to.be('8080');

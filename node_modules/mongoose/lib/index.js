 ...
 *
 *     // with mongodb:// URI
 *     db = mongoose.createConnection('mongodb://user:pass@192.168.132.129:port/database');
 *
 *     // and options
 *     var opts = { db: { native_parser: true }}
 *     db = mongoose.createConnection('mongodb://user:pass@192.168.132.129:port/database', opts);
 *
 *     // replica sets
 *     db = mongoose.createConnection('mongodb://user:pass@192.168.132.129:port,anotherhost:port,yetanother:port/database');
 *
 *     // and options
 *     var opts = { replset: { strategy: 'ping', rs_name: 'testSet' }}
 *     db = mongoose.createConnection('mongodb://user:pass@192.168.132.129:port,anotherhost:port,yetanother:port/database', opts);
 *
 *     // and options
 *     var opts = { server: { auto_reconnect: false }, user: 'username', pass: 'mypassword' }
 *     db = mongoose.createConnection('192.168.132.129', 'database', port, opts)
 *
 *     // initialize now, connect later
 *     db = mongoose.createConnection();
 *     db.openUri('192.168.132.129', 'database', port, [opts]);
 *
 ...
 * ####Example:
 *
 *     mongoose.connect('mongodb://user:pass@192.168.132.129:port/database');
 *
 *     // replica sets
 *     var uri = 'mongodb://user:pass@192.168.132.129:port,anotherhost:port,yetanother:port/mydatabase';
 ...
 *
 *     mongoose.createConnection('mongodb://192.168.132.129:27017/test');
